...
#   sha256sum torando-gui-1.3.1.tar.gz
class TorandoGui < Formula
  ...
  url "https://github.com/cristiancmoises/torando-gui/archive/refs/tags/v1.3.1.tar.gz"
  ...
  test do
    assert_match "1.3.1", shell_output("#{bin}/torando-guid --version")
  end
end
